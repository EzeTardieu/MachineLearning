...
print(dataset.tail())
#We'll remove missing values to make the example easier
dataset = dataset.dropna()

#We change the category origin into numeric categories
...
print(dataset.tail())
#Now we divide the dataset. We create a train dataset and a test dataset
